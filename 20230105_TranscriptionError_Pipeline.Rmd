---
title: "20221212_TranscriptionError_Pipeline"
...
#Analysis notes:
#the overrepresented sequences across all samples appear to be ribosomal RNA. This is consistent across all samples though, so I'm told it shouldn't necessarily be an issue. I may want to look into implementing a rRNA filtering step, but also these reads will be filtered out during count matrix generation... 
